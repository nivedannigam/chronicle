-- Superseded by 20260728120000_connector_connections_foundation.sql for standalone connector setup.
-- Chronicle Connector Framework + Google Drive first implementation
...
CREATE TABLE IF NOT EXISTS public.connector_document_registry (
	...
	health_report_id UUID REFERENCES public.health_reports(id) ON DELETE SET NULL,
