...
export function PropertyModuleFolderPicker({
	userId,
	open,
	onClose,
	onAssigned,
	...
	const { assignFolder } = usePropertySources(userId)
		...
		>
			...
			>
				...
				<p style={{ color: FC.dim, fontSize: 13, margin: '0 0 16px' }}>
					Chronicle will organize property documents found inside this folder.
					Nested folders like Pune Home, Registration, Tax, and Loan are
