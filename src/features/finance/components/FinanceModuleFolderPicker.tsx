...
export function FinanceModuleFolderPicker({
	userId,
	open,
	onClose,
	onAssigned,
	...
	const { assignFolder } = useFinanceSources(userId)
		...
		>
			...
			>
				...
				<p style={{ color: FC.dim, fontSize: 13, margin: '0 0 16px' }}>
					Choose the root Finance folder. Bank, Investments, Loans, Tax, and
					other nested folders will be included automatically.
				</p>
				...
				<div style={{ display: 'grid', gap: 8, marginBottom: 16 }}>
					{browser.folders.map((folder) => (
						...
						>
							<Folder size={16} color={C.greenAlt} />
