import type { KnowledgeContextPackage } from '@chronicle/core-knowledge'
import { createEmptyContextPackage } from '@chronicle/core-knowledge'
import type { ProviderContextResult } from '@chronicle/core-knowledge'
import type { KnowledgeDomain } from '@chronicle/core-knowledge'
import type { KnowledgeSemanticTimelineYear } from '@chronicle/core-knowledge'
...
function dedupeSemanticTimeline(
	groups: KnowledgeSemanticTimelineYear[],
): KnowledgeSemanticTimelineYear[] {
	const byYear = new Map<number, KnowledgeSemanticTimelineYear['events']>()
